...
import ru.aberezhnoy.math.core.presenters.Presenter;
import ru.aberezhnoy.math.core.views.View;
import ru.aberezhnoy.math.mathematics.calculatearea.CalculateArea;
...
public class App {
    ...
    public App() {
        ui = new ConsoleView();
        model = new Model(CalculateArea.getInstance(), "Noname.jpg");
